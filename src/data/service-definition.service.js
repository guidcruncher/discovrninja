...
exports.ServiceDefinitionService = void 0;
var common_1 = require("@nestjs/common");
var servicedefinition_dto_1 = require("./dto/servicedefinition.dto");
var ServiceDefinitionService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var ServiceDefinitionService = _classThis = /** @class */ (function () {
        function ServiceDefinitionService_1(configService, serviceDefModel) {
            this.configService = configService;
            this.serviceDefModel = serviceDefModel;
            this.logger = new common_1.Logger(ServiceDefinitionService.name);
        }
        ServiceDefinitionService_1.prototype.save = function (containerName, data) {
        ...
        ServiceDefinitionService_1.prototype.archive = function (containerName, archived) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        ServiceDefinitionService_1.prototype.get = function (containerName) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        ServiceDefinitionService_1.prototype.all = function (excludeArchived) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        return ServiceDefinitionService_1;
    }());
    __setFunctionName(_classThis, "ServiceDefinitionService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ServiceDefinitionService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ServiceDefinitionService = _classThis;
}();
exports.ServiceDefinitionService = ServiceDefinitionService;
