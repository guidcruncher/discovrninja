...
var configuration_reader_1 = require("./configuration.reader");
var ConfigurationModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    isGlobal: true,
                    load: [configuration_reader_1.ConfigReader.Read],
                }),
            ...
            controllers: [],
            providers: [],
            exports: [config_1.ConfigModule, nestjs_pino_1.LoggerModule],
        })];
