...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.getPayload = function (user) {
            var payload = {
                sub: user.userId,
        ...
        AuthService_1.prototype.signIn = function (username, pass) {
            this.logger.log("signIn " + username);
            var user = this.usersService.findOne(username);
            if (!user) {
            ...
            var payload = this.getPayload(user);
        ...
        AuthService_1.prototype.clearCookie = function (res) {
            this.setCookie(res, "");
        ...
        AuthService_1.prototype.setCookie = function (res, token) {
