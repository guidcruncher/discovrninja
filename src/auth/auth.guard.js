...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(jwtService, reflector) {
        ...
        AuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var isPublic, request, response, token, payload;
                return __generator(this, function (_a) {
                    isPublic = this.reflector.getAllAndOverride(decorators_1.IS_PUBLIC_KEY, [
                        context.getHandler(),
                        context.getClass(),
                    ]);
                    if (isPublic) {
