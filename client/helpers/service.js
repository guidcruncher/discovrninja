          ...
          case "widget":
            ...
            switch (realName) {
              ...
              case "television":
                ...
                f = Handlebars.partials["widget-tv"; html = f({
                    settings: settings,
                    parent: p,
                  });
                  break;
                  ...
                  f = Handlebars.partials["widget-video"]; html = f({
                    settings: settings,
                    parent: p,
                  });
                  break;
                  case "frame":
                  f = Handlebars.partials["widget-frame"]; html = f({
                    settings: settings,
                    parent: p,
                  });
                  break;
                  case "news":
                  serviceUrl =
                  "/api/resources/news?u=" + encodeURIComponent(settings.url); settings.serviceUrl = serviceUrl; settings.domainUrl = new URL(settings.url).hostname
                  .toLowerCase()
                  .replace("www.", ""); f = Handlebars.partials["widget-news"]; html = f({
                    settings: settings,
                    parent: p,
                  });
                  break;
                  ...
                  serviceUrl +
                  '"  data-template="widget-weather" ></div>'; settings.serviceUrl = serviceUrl;
                  break;
                  case "globe":
                  f = Handlebars.partials["widget-globe"]; html = f({
                    settings: settings,
                    parent: p,
                  });
                  break;
