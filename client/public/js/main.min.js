function newsPage(t) {
  window.open("/news?url=" + encodeURIComponent(t));
}
function navigateToNews(t) {
  var t = t.getAttribute("data-url"),
    t = "/api/resources/feed?url=" + encodeURIComponent(t),
    e = { focus: !0, backdrop: !0 };
  axios.get(t).then((t) => {
    t = t.data;
    document.getElementById("modal").classList.add("modal-diallog-scrollable"),
      (window.modal = new bootstrap.Modal(document.getElementById("modal"), e)),
      (document.querySelector("#modalLabel").innerHTML = "News"),
      (document.querySelector("#modalBody").innerHTML = app.templates.news(t)),
      window.modal.show();
  });
}
function viewWeather(t, e, n, a) {
  var o = { focus: !0, backdrop: "static" };
  ui()
    .weather({ latitude: t, longitude: e, days: n })
    .then((t) => {
      window.modal = new bootstrap.Modal(document.getElementById("modal"), o);
      var e = {};
      (document.querySelector("#modalLabel").innerHTML = "Weather"),
        (e = a && 0 <= a ? t.weather[a] : t.weather[0]),
        document
          .getElementById("modal")
          .classList.remove("modal-diallog-scrollable"),
        (e.location = t.location),
        (document.querySelector("#modalBody").innerHTML =
          app.templates.weather(e)),
        window.modal.show();
    })
    .catch((t) => {
      alert(t);
...
function navigateTo(t) {
  ...
  t = t.getAttribute("data-url");
  window.open(t);
}
function _desktop() {
  return JSON.parse(localStorage.getItem("desktop"));
}
function setBackground() {
  var e = _desktop().background;
  switch (e.type) {
    case "none":
      break;
    case "daily":
      var t = "/api/resources/daily/" + e.url;
      axios.get(t).then((t) => {
        var t = t.data;
        "" != t &&
          ...
          e.image) &&
          "" != (t = e.image.filter ?? "") &&
          (document.body.style.filter = t);
      });
      break;
    case "image":
      (document.body.style.backgroundImage = "url('" + e.url + "')"),
        (document.body.style.backgroundRepeat = "no-repeat"),
        (document.body.style.backgroundPosition = "center"),
        (document.body.style.backgroundAttachment = "fixed"),
        (document.body.style.backgroundSize = "cover"),
      ...
      break;
    case "bgcolor":
      document.body.style.backgroundColor = e.bgcolor;
      break;
    case "filter":
      document.body.style.backgroundImage = e.filter;
  }
}
function saveConfiguration() {
  ...
  document.getElementById("txtCompose").value,
    document.getElementById("txtEnv").value,
    document.getElementById("txtCompose").getAttribute("data-project");
  axios
    .post("/api/discovery/definition/" + encodeURIComponent(t.containerName), t)
    .then((t) => {
...
function composeEdit(t) {
  t =
    "/admin/edit?project=" +
    encodeURIComponent(t.getAttribute("data-project")) +
    "&container=" +
    encodeURIComponent(t.getAttribute("data-containerid"));
...
function iconSearch() {
  (document.getElementById("iconSearchQuery").value = ""),
    ...
    (window.iconSearchModal = new bootstrap.Modal(
      ...
      { focus: !0, backdrop: "static" },
    )),
    window.iconSearchModal.show(),
    document.getElementById("iconSearchQuery").focus();
}
function performIconSearch() {
  var t = document.querySelector("#iconSearchQuery").value,
    t = "/api/icons/search/" + encodeURIComponent(t),
    e = document.querySelector("#iconSearchResults"),
    a = document.getElementById("btnSearch").getAttribute("data-container"),
    o = document.getElementById("btnSearch").getAttribute("data-action");
  axios
    .get(t)
    .then((t) => {
      e.innerHTML = "";
      var n = '<table cellpadding="5" cellspacing="0" border="0">';
      t.data.forEach((t) => {
        var e = o + "('" + a + "', '" + t.catalog + "', '" + t.slug + "')";
        n +=
...
function doDeComposerise(t, e) {
  var t = document.querySelector(t),
    n = document.querySelector(e),
    e = { cmd: t.value };
  axios
    .post("/api/compose/decomposerize", e)
    .then((t) => {
      n.value = t.data;
    })
    .catch((t) => {
...
function doComposerise(t, e) {
  var t = document.querySelector(t),
    n = document.querySelector(e),
    e = { cmd: t.value };
  axios
    .post("/api/compose/composerize", e)
...
function scanDocker() {
  axios
    ...
    .then((t) => {
      ui().messageBox({ label: "Scan", body: "Service Discovery complete." });
    })
    .catch((t) => {
      alert(t);
    });
...
function updateDNS() {
  axios
    .get("/api/discovery/scan/updatedns")
    .then((t) => {
      ui().messageBox({ label: "DNS", body: "DNS Update complete." });
    })
    .catch((t) => {
      alert(t);
    });
}
function respondEnter(t) {
  ("Enter" != t.key && 13 != t.keyCode) ||
    document.getElementById("btnSearch").click();
}
function changeIcon(t, e) {
  var n = t.getAttribute("data-containerid"),
    t = "/api/discovery/definition/" + encodeURIComponent(n);
  axios
    .get(t)
    .then((t) => {
      document.getElementById("btnSearch").setAttribute("data-container", n),
        document
          .getElementById("btnSearch")
          .setAttribute("data-action", "saveChangeIcon"),
        e &&
          document.getElementById("btnSearch").setAttribute("data-action", e),
        (window.iconSearchModal = new bootstrap.Modal(
          document.getElementById("iconSearchModal"),
          { focus: !0, backdrop: "static" },
        )),
...
function getSeries(e, t) {
  var n = [],
    a = 0;
  return (
    e[t].forEach((t) => {
      n.push({ x: new Date(e.periods[a]).getTime(), y: t }), (a += 1);
    }),
    n
  );
}
function getLog(t) {
  axios
    .get("/api/docker/container/logs/" + t)
    .then((t) => {
      document.getElementById("containerLogs").innerHTML = t.data;
    })
    .catch((t) => {});
}
function renderDashboard(n) {
  var t = "/api/docker/dashboard/" + n;
  getLog(n),
    (document.querySelector("#monitorContainerName").innerHTML = n),
    axios
      .get(t)
      .then((t) => {
        var e;
        (e = {
          chart: { height: 300, width: 320, type: "line" },
          title: { text: "Historical CPU Load %" },
          stroke: { curve: "smooth" },
          markers: { size: 5 },
          series: [{ name: "Load", data: getSeries(t.data, "cpuPercent") }],
          xaxis: { labels: { show: !1 } },
          yaxis: {
            labels: {
          ...
          new ApexCharts(document.querySelector("#cpuchart"), e).render(),
          (e = {
            chart: { height: 300, width: 320, type: "line" },
            title: { text: "Historical Free Memory %" },
            stroke: { curve: "smooth" },
            markers: { size: 5 },
            series: [
              { name: "Load", data: getSeries(t.data, "memoryFreePercent") },
            ],
            xaxis: { labels: { show: !1 } },
            yaxis: {
              labels: {
          ...
          new ApexCharts(document.querySelector("#memorychart"), e).render(),
...
function startContainerMonitor(t) {
  t = t.getAttribute("data-containerid");
  window.containerInfoModal.hide(),
    document.querySelector("#nav-monitor-tab").click(),
    window._monitor &&
      (clearTimeout(window._monitor), (window._monitor = null)),
    renderDashboard(t);
}
function containerInfo(t) {
  var e = { focus: !0, backdrop: "static" },
    t = t.getAttribute("data-containerid");
  ui("#containerInfo")
    .template({ query: { id: t } })
    .then(() => {
      ...
      var t = document.querySelectorAll("[data-command]");
      t &&
        t.forEach((t) => {
          t.onclick = function () {
            var t =
...
function updateEditForm(t, e, n) {
  (document.getElementById("txticonSlug").value = n),
    (document.getElementById("txticonCatalog").value = e);
  e = "/api/icons/r/" + encodeURIComponent(e) + "/" + encodeURIComponent(n);
  axios
    .get(e)
    .then((t) => {
      (document.getElementById("imgIcon").src = t.data),
        window.iconSearchModal.hide();
    })
    .catch((t) => {
      alert(t);
...
function changeIconFromEdit() {
  document.getElementById("txticonCatalog").value;
  var t = document.getElementById("txticonSlug").value;
  document.getElementById("btnSearch").setAttribute("data-container", name),
    ...
    (document.getElementById("iconSearchQuery").value = ""),
    (document.getElementById("iconSearchResults").innerHTML = "") != t &&
      "" != (document.getElementById("iconSearchQuery").value = t) &&
      performIconSearch(),
    document.getElementById("btnSearch").setAttribute("data-container", name),
    window.iconSearchModal.show(),
    document.getElementById("iconSearchQuery").focus();
...
((t, e) => {
  ...
  return (
    (a = [
        ...
        function a() {
          ...
          return (
            (n.compile = function (t, e) {
              return l.compile(t, e, n);
            }),
            (n.precompile = function (t, e) {
              return l.precompile(t, e, n);
            }),
            (n.AST = i.default),
            (n.Compiler = l.Compiler),
            (n.JavaScriptCompiler = c.default),
            (n.Parser = s.parser),
            (n.parse = s.parse),
            (n.parseWithoutProcessing = s.parseWithoutProcessing),
            n
          );
        }
        var o = n(1).default;
      ...
      function (t, e, n) {
        ...
        var o = n(1).default,
          r = ((e.__esModule = !0), (e.HandlebarsEnvironment = a), n(5)),
          i = o(n(6)),
          s = n(10),
          l = n(70),
          o = o(n(72)),
          ...
          n =
            ...
            o.default.log);
        (e.log = n), (e.createFrame = r.createFrame), (e.logger = o.default);
      },
      function (t, e) {
        function n(t) {
          return o[t];
        ...
        (e.__esModule = !0),
          ...
          (e.escapeExpression = function (t) {
            ...
            return i.test(t) ? t.replace(r, n) : t;
          }),
      ...
      function (t, e, n) {
        function l(t, e) {
          ...
          e &&
            ...
            (t += " - " + n + ":" + o));
          for (
            var i = Error.prototype.constructor.call(this, t), s = 0;
            s < u.length;
            s++
          )
            this[u[s]] = i[u[s]];
          ...
          try {
            e &&
              ...
              c
                ...
                : ((this.column = o), (this.endColumn = r)));
          } catch (t) {}
        }
        var c = n(7).default,
          u =
          ...
          o.registerHelper("blockHelperMissing", function (t, e) {
            ...
            return !0 === t
              ...
              : !1 === t || null == t
                ...
                : r.isArray(t)
                  ? 0 < t.length
                    ? (e.ids && (e.ids = [e.name]), o.helpers.each(t, e))
                    : n(this)
                  : (e.data &&
                      e.ids &&
                      (((n = r.createFrame(e.data)).contextPath =
                        r.appendContextPath(e.data.contextPath, e.name)),
                      (e = { data: n })),
                    a(t, e));
          });
        }),
      ...
      function (t, e, n) {
        var m = n(13).default,
          ...
          y = n(60).default,
          a = n(1).default,
          b = ((e.__esModule = !0), n(5)),
          v = a(n(6));
        (e.default = function (t) {
          t.registerHelper("each", function (a, t) {
            function e(t, e, n) {
              l &&
                ((l.key = t),
                (l.index = e),
                ...
                (s += o(a[t], {
                  data: l,
                  blockParams: b.blockParams([a[t], t], [c + t, null]),
                }));
            }
            ...
            if (
              (t.data &&
                t.ids &&
                (c = b.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
              b.isFunction(a) && (a = a.call(this)),
              t.data && (l = b.createFrame(t.data)),
              a && "object" == typeof a)
            )
              if (b.isArray(a))
                for (var u = a.length; i < u; i++)
                  i in a && e(i, i, i === a.length - 1);
              else if ("function" == typeof m && a[f]) {
                for (var p = [], h = g(a), d = h.next(); !d.done; d = h.next())
                  p.push(d.value);
                for (u = (a = p).length; i < u; i++)
                  e(i, i, i === a.length - 1);
              } else
                (n = void 0),
                  y(a).forEach(function (t) {
                    void 0 !== n && e(n, i - 1), (n = t), i++;
                  }),
                  void 0 !== n && e(n, i - 1, !0);
            return (s = 0 === i ? r(this) : s);
          });
        }),
          (t.exports = e.default);
      },
      ...
      function (D, j, t) {
          ...
          return (
            ...
            p &&
              ...
              B(M, e, {
                configurable: !0,
                set: function (t) {
                  u(this, O) && u(this[O], e) && (this[O][e] = !1),
                    B(this, e, k(1, t));
                },
              }),
            t
        ...
        function a(t, e) {
          U(t);
          for (var n, a = $((e = v(e))), o = 0, r = a.length; o < r; )
            H(t, (n = a[o++]), e[n]);
          return t;
        }
        function e(t, e) {
          return void 0 === e ? w(t) : a(w(t), e);
        }
        function o(t) {
          var e = V.call(this, t);
          return (
            !(e || !u(this, t) || !u(N, t) || (u(this, O) && this[O][t])) || e
          );
        }
        function r(t, e) {
          var n = x((t = v(t)), e);
          return (
            !n || !u(N, e) || (u(t, O) && t[O][e]) || (n.enumerable = !0), n
          );
        }
        function i(t) {
          for (var e, n = q(v(t)), a = [], o = 0; n.length > o; )
            u(N, (e = n[o++])) || e == O || a.push(e);
          return a;
        }
        function s(t) {
          for (var e, n = q(v(t)), a = [], o = 0; n.length > o; )
            u(N, (e = n[o++])) && a.push(N[e]);
          return a;
        }
        var l = t(9),
          c = t(16),
          ...
          B =
            ...
            m(function () {
              ...
              ? function (t, e, n) {
                  var a = x(M, e);
                  a && delete M[e], S(t, e, n), a && t !== M && S(M, e, a);
                }
              : S,
          A = function (t) {
            ...
            (L ||
              (d(
                (P = function () {
                  ...
                  return n(T(0 < arguments.length ? arguments[0] : void 0));
                }).prototype,
                "toString",
                function () {
                  return this._k;
              ...
              (l.getNames = b.get = i),
              (l.getSymbols = s),
              p && !t(41) && d(M, "propertyIsEnumerable", o, !0)),
            {
              for: function (t) {
                return u(C, (t += "")) ? C[t] : (C[t] = P(t));
              },
              keyFor: function (t) {
                return R(C, t);
              },
          ...
          _ &&
            h(h.S + h.F * (!L || f), "JSON", {
              stringify: function (t) {
                if (void 0 !== t && !A(t)) {
                  for (var n, e = [t], a = 1, o = arguments; a < o.length; )
                    e.push(o[a++]);
                  return (
                    (!(n = "function" == typeof (t = e[1]) ? t : n) && F(t)) ||
                      (t = function (t, e) {
                        if ((n && (e = n.call(this, t, e)), !A(e))) return e;
                      }),
                    (e[1] = t),
                    E.apply(_, e)
                  );
      ...
      function (t, e, n) {
        var a = n(27)("wks"),
          ...
          r = n(16).Symbol;
        t.exports = function (t) {
          return a[t] || (a[t] = (r && r[t]) || (r || o)("Symbol." + t));
        };
      },
      function (t, e) {
        var n = 0,
      ...
      function (t, e, n) {
        var s = n(9),
          l = n(32);
        t.exports = function (t, e) {
          for (var n, a = l(t), o = s.getKeys(a), r = o.length, i = 0; i < r; )
            if (a[(n = o[i++])] === e) return n;
        };
      },
      function (t, e, n) {
        var a = n(33),
      ...
      function (t, e, n) {
        ...
        t.exports.get = function (t) {
          if (!i || "[object Window]" != r.call(t)) return o(a(t));
          try {
            return o(t);
          } catch (t) {
            return i.slice();
      ...
      function (t, e, n) {
        ...
        t.exports = function (t) {
          var e = s.getKeys(t),
            n = s.getSymbols;
          if (n)
            for (var a, o = n(t), r = s.isEnum, i = 0; o.length > i; )
              r.call(t, (a = o[i++])) && e.push(a);
          return e;
        };
      },
      function (t, e, n) {
      ...
      function (t, e, n) {
        ...
        n(48)(
          ...
          function () {
            ...
            return e >= t.length
              ? { value: void 0, done: !0 }
              : ((t = a(t, e)), (this._i += t.length), { value: t, done: !1 });
          },
        );
      },
      function (t, e, n) {
      ...
      function (t, e, n) {
        ...
        var g = n(41),
          ...
          I = "@@iterator",
          O = "values";
        t.exports = function (t, e, n, a, o, r, i) {
          S(n, e, a);
          function s(t) {
            if (!E && t in h) return h[t];
            switch (t) {
              case "keys":
              case O:
                return function () {
          ...
          if (
            ...
            if (
              ((l = {
                values: u ? m : s(O),
                keys: r ? m : s("keys"),
                entries: u ? s("entries") : m,
              }),
              i)
            )
              for (c in l) c in h || b(h, c, l[c]);
            else y(y.P + y.F * (E || p), e, l);
          return l;
        };
      },
      function (t, e) {
      ...
      function (t, e, n) {
        var a = n(9),
          ...
          r = n(28),
          i = {};
        n(25)(i, n(29)("iterator"), function () {
          return this;
        }),
          (t.exports = function (t, e, n) {
            (t.prototype = a.create(i, { next: o(1, n) })),
              r(t, e + " Iterator");
          });
      },
      function (t, e, n) {
      ...
      function (t, e, n) {
        ...
        t.exports = n(21).getIteratorMethod = function (t) {
          if (null != t) return t[o] || t["@@iterator"] || r[a(t)];
        };
      },
      function (t, e, n) {
        var a = n(34),
      ...
      function (t, e, n) {
        var a = n(1).default,
          o = ((e.__esModule = !0), n(5)),
          r = a(n(6));
        (e.default = function (n) {
          n.registerHelper("if", function (t, e) {
            if (2 != arguments.length)
              throw new r.default("#if requires exactly one argument");
            return (
            ...
            n.registerHelper("unless", function (t, e) {
              if (2 != arguments.length)
                throw new r.default("#unless requires exactly one argument");
        ...
        (e.__esModule = !0),
          (e.default = function (o) {
            o.registerHelper("log", function () {
              for (
                var t = [void 0], e = arguments[arguments.length - 1], n = 0;
              ...
              null != e.hash.level
                ? (a = e.hash.level)
                : e.data && null != e.data.level && (a = e.data.level),
                (t[0] = a),
                o.log.apply(o, t);
            });
          }),
          ...
          t.registerHelper("with", function (t, e) {
            ...
            return o.isEmpty(t)
              ...
              : ((n = e.data),
                e.data &&
                  e.ids &&
                  ((n = o.createFrame(e.data)).contextPath =
      ...
      function (t, e, n) {
        ...
        var i = n(5);
        (e.default = function (t) {
          t.registerDecorator("inline", function (a, o, r, t) {
            var e = a;
            return (
              o.partials ||
                ((o.partials = {}),
                (e = function (t, e) {
                  var n = r.partials,
                    t = ((r.partials = i.extend({}, n, o.partials)), a(t, e));
                  return (r.partials = n), t;
                })),
        ...
        var a = n(5),
          o = {
            ...
            lookupLevel: function (t) {
              ...
              return (t =
                "string" == typeof t
                  ? 0 <= (e = a.indexOf(o.methodMap, t.toLowerCase()))
                    ? e
                    : parseInt(t, 10)
                  : t);
            },
          ...
          o =
            ...
            (e.createNewLookupObject = function () {
              for (var t = arguments.length, e = Array(t), n = 0; n < t; n++)
                e[n] = arguments[n];
              return o.extend.apply(void 0, [a(null)].concat(e));
            }),
            n(5));
      },
      function (t, e) {
      ...
      function (t, e, n) {
          ...
          function n(t) {
            ...
            return (
              ...
              o(
                ...
                a.partials,
                e.data || r,
                i && [e.blockParams].concat(i),
                n,
              )
            );
          }
          return (
            ((n = h(o, n, a, s, r, i)).program = t),
        ...
        function h(t, e, n, a, o, r) {
          return (
            t.decorator &&
              ((e = t.decorator(e, (t = {}), n, a && a[0], o, r, a)),
              d.extend(e, t)),
            e
          );
        }
        ...
        (e.__esModule = !0),
          (e.checkRevision = function (t) {
            ...
            if (
              !(
                f.LAST_COMPATIBLE_COMPILER_REVISION <= e &&
                e <= f.COMPILER_REVISION
              )
            ) {
              if (e < f.LAST_COMPATIBLE_COMPILER_REVISION)
                throw (
                  ((n = f.REVISION_CHANGES[n]),
                  (e = f.REVISION_CHANGES[e]),
                  new m.default(
          ...
          (e.template = function (l, c) {
            function u(t) {
              function e(t) {
                return "" + l.main(p, t, p.helpers, p.partials, r, s, i);
              }
              var n,
                a,
                o =
                ...
                l.useDepths &&
                  (i = o.depths
                    ? t != o.depths[0]
                      ...
                      : o.depths
                    : [t]),
                (e = h(l.main, e, p, o.depths || [], r, s))(t, o)
              );
            }
            if (!c) throw new m.default("No environment passed to template");
            if (!l || !l.main)
              throw new m.default("Unknown template object: " + typeof l);
            (l.main.decorator = l.main_d), c.VM.checkRevision(l.compiler);
            var n = l.compiler && 7 === l.compiler[0],
              p = {
                strict: function (t, e, n) {
                  if (t && e in t) return p.lookupProperty(t, e);
                ...
                lookupProperty: function (t, e) {
                  ...
                  return null == n ||
                    ...
                    b.resultIsAllowed(n, p.protoAccessControl, e)
                    ? n
                    : void 0;
                },
                lookup: function (t, e) {
                  for (var n = t.length, a = 0; a < n; a++)
                    if (null != (t[a] && p.lookupProperty(t[a], e)))
                      return t[a][e];
                },
                lambda: function (t, e) {
                ...
                invokePartial: function (t, e, n) {
                  n.hash &&
                    ((e = d.extend({}, e, n.hash)), n.ids) &&
                    (n.ids[0] = !0),
                    (t = c.VM.resolvePartial.call(this, t, e, n));
                  var a = d.extend({}, n, {
                      hooks: this.hooks,
                      protoAccessControl: this.protoAccessControl,
                    }),
                    o = c.VM.invokePartial.call(this, t, e, a);
                  if (
                    (null == o &&
                      c.compile &&
                      ((n.partials[n.name] = c.compile(
                        t,
                        l.compilerOptions,
                        c,
                      )),
                      (o = n.partials[n.name](e, a))),
                    null == o)
                  )
                    throw new m.default(
                      "The partial " +
                ...
                programs: [],
                program: function (t, e, n, a, o) {
                  var r = this.programs[t],
                    i = this.fn(t);
                  return (r =
                    e || o || a || n
                      ? s(this, t, i, e, n, a, o)
                      : r || (this.programs[t] = s(this, t, i)));
                },
                data: function (t, e) {
                  for (; t && e--; ) t = t._parent;
                  return t;
                ...
                mergeIfNeeded: function (t, e) {
                  var n = t || e;
                  return (n = t && e && t !== e ? d.extend({}, e, t) : n);
                },
                nullContext: a({}),
                noop: c.VM.noop,
            ...
            return (
              ...
              (u._setup = function (t) {
                var e, a, o;
                t.partial
                  ? ((p.protoAccessControl = t.protoAccessControl),
                    (p.helpers = t.helpers),
                    (p.partials = t.partials),
                    (p.decorators = t.decorators),
                    (p.hooks = t.hooks))
                  : ((e = d.extend({}, c.helpers, t.helpers)),
                    (o = p),
                    r((a = e)).forEach(function (t) {
                      var e,
                        n = a[t];
                      a[t] =
                        ((e = o.lookupProperty),
                        y.wrapHelper(n, function (t) {
                          return d.extend({ lookupProperty: e }, t);
                        }));
                    }),
                    (p.helpers = e),
                    l.usePartial &&
                      (p.partials = p.mergeIfNeeded(t.partials, c.partials)),
                    (l.usePartial || l.useDecorators) &&
                      (p.decorators = d.extend({}, c.decorators, t.decorators)),
                    (p.hooks = {}),
                    (p.protoAccessControl = b.createProtoAccessControl(t)),
                    (e = t.allowCallsToHelperMissing || n),
                    g.moveHelperToHooks(p, "helperMissing", e),
                    g.moveHelperToHooks(p, "blockHelperMissing", e));
              }),
              (u._child = function (t, e, n, a) {
                if (l.useBlockParams && !n)
                  throw new m.default("must pass block params");
                if (l.useDepths && !a)
                  throw new m.default("must pass parent depths");
                return s(p, t, l[t], e, 0, n, a);
              }),
              u
            );
          }),
      ...
      function (t, e, n) {
        function a(t, e) {
          return "Program" === t.type
            ? t
            : (((i.default.yy = l).locInfo = function (t) {
        ...
        var o = n(1).default,
          r = n(3).default;
        (e.__esModule = !0),
          (e.parseWithoutProcessing = a),
          (e.parse = function (t, e) {
            return (t = a(t, e)), new s.default(e).accept(t);
          });
        var i = o(n(86)),
          s = o(n(87)),
          o = r(n(89)),
          r = n(5),
          l = ((e.parser = i.default), {});
        r.extend(l, o);
      },
      function (t, e) {
        e.__esModule = !0;
        (n = {
          ...
          performAction: function (t, e, n, a, o, r, i) {
            var s = r.length - 1;
            switch (o) {
              case 1:
                return r[s - 1];
              case 2:
                this.$ = a.prepareProgram(r[s]);
                break;
              case 3:
              case 4:
              case 5:
              ...
              case 9:
                this.$ = {
                  ...
                  value: a.stripComment(r[s]),
                  strip: a.stripFlags(r[s], r[s]),
              ...
              case 10:
                ...
                break;
              case 11:
                this.$ = a.prepareRawBlock(r[s - 2], r[s - 1], r[s], this._$);
                break;
              case 12:
                this.$ = { path: r[s - 3], params: r[s - 2], hash: r[s - 1] };
                break;
              case 13:
                this.$ = a.prepareBlock(
                  r[s - 3],
              ...
              case 18:
                this.$ = {
                  strip: a.stripFlags(r[s - 1], r[s - 1]),
                  program: r[s],
                };
                break;
              case 19:
                var l = a.prepareBlock(
                  ...
                  l = a.prepareProgram([l], r[s - 1].loc);
                (l.chained = !0),
                  (this.$ = { strip: r[s - 2].strip, program: l, chain: !0 });
                break;
              case 20:
                this.$ = r[s];
                break;
              ...
              case 29:
                ...
                break;
              case 30:
                this.$ = { type: "Hash", pairs: r[s], loc: a.locInfo(this._$) };
                break;
              case 31:
                this.$ = {
                  type: "HashPair",
              ...
              case 41:
                ...
                break;
              case 42:
                this.$ = a.preparePath(!0, r[s], this._$);
                break;
              case 43:
                this.$ = a.preparePath(!1, r[s], this._$);
                break;
              case 44:
                r[s - 2].push({
                  part: a.id(r[s]),
                ...
                break;
              case 45:
                this.$ = [{ part: a.id(r[s]), original: r[s] }];
                break;
              case 46:
                this.$ = [];
                break;
            ...
            var e = this,
              ...
              u =
                ...
                void 0 === (this.yy.parser = this).lexer.yylloc &&
                  (this.lexer.yylloc = {}),
                this.lexer.yylloc),
              p = (o.push(u), this.lexer.options && this.lexer.options.ranges);
            "function" == typeof this.yy.parseError &&
              (this.parseError = this.yy.parseError);
            for (var h, d, m, f, g, y, b, v, k = {}; ; ) {
              if (
                ((m = n[n.length - 1]),
                void 0 ===
                  (f =
          ...
          unput: function (t) {
            ...
            return (
              (this.yylloc = {
                ...
                last_column: n
                  ? (n.length === t.length ? this.yylloc.first_column : 0) +
                    t[t.length - n.length].length -
                    n[0].length
          ...
          pastInput: function () {
            ...
            return (
              (20 < t.length ? "..." : "") + t.substr(-20).replace(/\n/g, "")
            );
          },
          ...
          next: function () {
            ...
            for (
              ...
              r < o.length &&
              (!(e = this._input.match(this.rules[o[r]])) ||
                (t && !(e[0].length > t[0].length)) ||
                ((t = e), (n = r), this.options.flex));
              r++
            );
            return t
              ? ((a = t[0].match(/(?:\r\n?|\n).*/g)) &&
          ...
          options: {},
          performAction: function (t, n, e, a) {
            function o(t, e) {
            ...
            switch (e) {
              ...
              case 31:
                return (n.yytext = o(1, 2).replace(/\\"/g, '"')), 80;
              case 32:
                return (n.yytext = o(1, 2).replace(/\\'/g, "'")), 80;
              case 33:
                return 85;
        ...
        var n = new ((a.prototype = n).Parser = a)();
        function a() {
          this.yy = {};
        }
        (e.default = n), (t.exports = e.default);
      ...
      function (t, e, n) {
        ...
        function h(t, e, n) {
          var a = t[(e = void 0 === e ? t.length : e) - 1];
          return a
        ...
        function m(t, e, n) {
          ...
          !t ||
            ...
            (!n && t.rightStripped) ||
            ((e = t.value),
            (t.value = t.value.replace(n ? /^\s+/ : /^[ \t]*\r?\n?/, "")),
            (t.rightStripped = t.value !== e));
        }
        function f(t, e, n) {
          t = t[null == e ? t.length - 1 : e - 1];
          if (t && "ContentStatement" === t.type && (n || !t.leftStripped))
            return (
              (e = t.value),
              (t.value = t.value.replace(n ? /\s+$/ : /[ \t]+$/, "")),
        ...
        e.__esModule = !0;
        o = o(n(88));
        ((a.prototype = new o.default()).Program = function (t) {
          var e = !this.options.ignoreStandalone,
            n = !this.isRootSeen;
          this.isRootSeen = !0;
          for (var a = t.body, o = 0, r = a.length; o < r; o++) {
            var i,
              s,
              l,
              c,
            ...
            p &&
              ((c = h(a, o, n)),
              (i = d(a, o, n)),
              (s = p.openStandalone && c),
              (l = p.closeStandalone && i),
              (c = p.inlineStandalone && c && i),
              p.close && m(a, o, !0),
              p.open && f(a, o, !0),
              e &&
                c &&
                ...
                (u.indent = /([ \t]+$)/.exec(a[o - 1].original)[1]),
              e && s && (m((u.program || u.inverse).body), f(a, o)),
              e) &&
              l &&
              (m(a, o), f((u.inverse || u.program).body));
          }
          return t;
        }),
          (a.prototype.BlockStatement =
            a.prototype.DecoratorBlock =
            a.prototype.PartialBlockStatement =
              function (t) {
                ...
                var e = t.program || t.inverse,
                  ...
                  o = n;
                if (n && n.chained)
                  for (a = n.body[0].program; o.chained; )
                    o = o.body[o.body.length - 1].program;
                var r = {
                  open: t.openStrip.open,
                  close: t.closeStrip.close,
                  openStandalone: d(e.body),
                  closeStandalone: h((a || e).body),
                };
                return (
                  t.openStrip.close && m(e.body, null, !0),
                  n
                    ? ((n = t.inverseStrip).open && f(e.body, null, !0),
                      n.close && m(a.body, null, !0),
                      t.closeStrip.open && f(o.body, null, !0),
                      !this.options.ignoreStandalone &&
                        h(e.body) &&
                        d(a.body) &&
                        (f(e.body), m(a.body)))
                    : t.closeStrip.open && f(e.body, null, !0),
                  r
                );
              }),
          (a.prototype.Decorator = a.prototype.MustacheStatement =
            function (t) {
              return t.strip;
            }),
      ...
      function (t, e, n) {
        ...
        (a.prototype = {
          ...
          PartialBlockStatement: function (t) {
            i.call(this, t), this.acceptKey(t, "program");
          },
      ...
      function (t, e, n) {
        function c(t, e) {
          ...
          if (((e = e.path ? e.path.original : e), t.path.original !== e))
            throw (
              ((n = { loc: t.path.loc }),
              new u.default(t.path.original + " doesn't match " + e, n))
            );
        }
        var a = n(1).default;
        (e.__esModule = !0),
          ...
          (e.preparePath = function (t, e, n) {
            ...
            for (
              ...
              if (
                ...
                if (0 < o.length)
                  throw new u.default("Invalid path: " + a, { loc: n });
                ".." === l && r++;
              }
            }
            return {
          ...
          (e.prepareMustache = function (t, e, n, a, o, r) {
            var i = "{" !== (i = a.charAt(3) || a.charAt(2)) && "&" !== i;
            return {
          ...
          (e.prepareRawBlock = function (t, e, n, a) {
            return (
              c(t, n),
              (a = this.locInfo(a)),
              {
                ...
                params: t.params,
                hash: t.hash,
                program: { type: "Program", body: e, strip: {}, loc: a },
                openStrip: {},
                inverseStrip: {},
                closeStrip: {},
                loc: a,
          ...
          (e.prepareBlock = function (t, e, n, a, o, r) {
            a && a.path && c(t, a);
            var i = /\*/.test(t.open),
              s = ((e.blockParams = t.blockParams), void 0),
              l = void 0;
            if (n) {
              if (i)
                throw new u.default("Unexpected inverse block on decorator", n);
              n.chain && (n.program.body[0].closeStrip = a.strip),
                (l = n.strip),
                (s = n.program);
            }
            return (
          ...
          (e.prepareProgram = function (t, e) {
            ...
            return {
              ...
              loc: (e =
                !e &&
                t.length &&
                ((n = t[0].loc), (t = t[t.length - 1].loc), n) &&
                t
                  ? {
                      source: n.source,
          ...
          (e.preparePartialBlock = function (t, e, n, a) {
            return (
              c(t, n),
              {
      ...
      function (t, e, n) {
        ...
        (e.__esModule = !0),
          ...
          (e.precompile = function (t, e, n) {
            ...
            return (
              ...
              (t = n.parse(t, e)),
              (t = new n.Compiler().compile(t, e)),
              new n.JavaScriptCompiler().compile(t, e)
            );
          }),
          (e.compile = function (e, n, a) {
            function o() {
              var t = a.parse(e, n),
                t = new a.Compiler().compile(t, n),
                t = new a.JavaScriptCompiler().compile(t, n, void 0, !0);
              return a.template(t);
            }
            function t(t, e) {
              return (r = r || o()).call(this, t, e);
            }
            if (
              (void 0 === n && (n = {}),
            ...
            "data" in (n = l.extend({}, n)) || (n.data = !0),
              n.compat && (n.useDepths = !0);
            var r = void 0;
            return (
              (t._setup = function (t) {
                return (r = r || o())._setup(t);
              }),
              (t._child = function (t, e, n, a) {
                return (r = r || o())._child(t, e, n, a);
              }),
              t
            );
          });
        ...
        a.prototype = {
          ...
          equals: function (t) {
            ...
            for (var n = 0; n < e; n++) {
              ...
              if (
                ...
                !(function t(e, n) {
                  if (e === n) return 1;
                  if (l.isArray(e) && l.isArray(n) && e.length === n.length) {
          ...
          Program: function (t) {
            ...
            for (var e = t.body, n = e.length, a = 0; a < n; a++)
              this.accept(e[a]);
            return (
          ...
          helperSexpr: function (t, e, n) {
            var e = this.setupFullMustacheParams(t, e, n),
              n = t.path,
              a = n.parts[0];
          ...
          PathExpression: function (t) {
            ...
            var e = t.parts[0],
              ...
              a = !t.depth && !n && this.blockParamIndex(e);
            a
          ...
          classifySexpr: function (t) {
            var e = c.default.helpers.simpleId(t.path),
              ...
              a = !n && c.default.helpers.helperExpression(t),
              n = !n && (a || e);
            return (
              n &&
                !a &&
                ...
                (t = this.options).knownHelpers[e]
                  ? (a = !0)
                  : t.knownHelpersOnly && (n = !1)),
              a ? "helper" : n ? "ambiguous" : "simple"
            );
          },
          ...
          pushParam: function (t) {
            var e,
              n,
              a = null != t.value ? t.value : t.original || "";
            this.stringParams
              ? (a.replace &&
                  (a = a.replace(/^(\.?\.\/)*/g, "").replace(/\//g, ".")),
                t.depth && this.addDepth(t.depth),
                this.opcode("getContext", t.depth || 0),
                this.opcode("pushStringParam", a, t.type),
              ...
              : (this.trackIds &&
                  ...
                  (e =
                    ...
                    ? ((n = t.parts.slice(1).join(".")),
                      this.opcode("pushId", "BlockParam", e, n))
                    : ((a = t.original || a).replace &&
                        (a = a
                          .replace(/^this(?:\.|$)/, "")
                          .replace(/^\.\//, "")
                          .replace(/^\.$/, "")),
                      this.opcode("pushId", t.type, a))),
                this.accept(t));
          },
          setupFullMustacheParams: function (t, e, n, a) {
            var o = t.params;
            return (
              this.pushParams(o),
              this.opcode("pushProgram", e),
      ...
      function (t, e, n) {
        ...
        a.prototype = {
          ...
          compile: function (t, e, n, a) {
            ...
            n = this.createFunctionContext(a);
            if (this.isChild) return n;
            var c = { compiler: this.compilerInfo(), main: n },
              t =
                (this.decorators &&
            ...
            return (
              ...
              a
                ...
                : ((c.compiler = JSON.stringify(c.compiler)),
                  ...
                  e.srcName
                    ? ((c = c.toStringWithSourceMap({ file: e.destName })).map =
                        c.map && c.map.toString())
                    : (c = c.toString())),
              c
            );
          },
          ...
          createFunctionContext: function (t) {
            var n = this,
              ...
              r =
                ...
                this.mergeSource(a));
            return t
              ? (e.push(r), Function.apply(this, e))
              : this.source.wrap(["function(", e.join(","), ") {\n  ", r, "}"]);
          },
          ...
          blockValue: function (t) {
            var e = this.aliasable("container.hooks.blockHelperMissing"),
              ...
              t = (this.setupHelperArgs(t, 0, n), this.popStack());
            n.splice(1, 0, t),
          ...
          lookupOnContext: function (t, e, n, a) {
            var o = 0;
            a || !this.options.compat || this.lastContext
              ? this.pushContext()
              : this.push(this.depthedLookup(t[o++])),
          ...
          resolvePath: function (n, a, o, r, t) {
            var i = this;
            if (this.options.strict || this.options.assumeObjects)
              this.push(
                ((t, e, n, a, o) => {
                  var r = e.popStack(),
                    i = n.length;
                  for (t && i--; a < i; a++) r = e.nameLookup(r, n[a], o);
                  return t
                    ? [
                    ...
                    : r;
                })(this.options.strict && t, this, a, o, n),
              );
            else
              for (var e = a.length; o < e; o++)
                this.replaceStack(function (t) {
                  var e = i.nameLookup(t, a[o], n);
                  return r ? [" && ", e] : [" != null ? ", e, " : ", t];
                });
          },
          ...
          invokeHelper: function (t, e, n) {
            var a = this.popStack(),
              ...
              n =
                ...
                ["(", this.itemsSeparatedBy(e, "||"), ")"]),
              a = this.source.functionCall(n, "call", t.callParams);
            this.push(a);
          },
          itemsSeparatedBy: function (t, e) {
            var n = [];
            n.push(t[0]);
            for (var a = 1; a < t.length; a++) n.push(e, t[a]);
            return n;
          },
          ...
          invokePartial: function (t, e, n) {
            var a = [],
              o = this.setupParams(e, 1, a);
            t && ((e = this.popStack()), delete o.name),
          ...
          assignToHash: function (t) {
            var e = this.popStack(),
              ...
              r =
                ...
                this.stringParams &&
                  ((a = this.popStack()), (n = this.popStack())),
                this.hash);
            n && (r.contexts[t] = n),
              a && (r.types[t] = a),
              o && (r.ids[t] = o),
          ...
          compileChildren: function (t, e) {
            for (
              var n = t.children, a = void 0, o = void 0, r = 0, i = n.length;
              r < i;
              r++
            ) {
              var s,
                a = n[r],
                o = new this.compiler(),
                l = this.matchExistingProgram(a);
              null == l
                ? (this.context.programs.push(""),
                  (s = this.context.programs.length),
                  (a.index = s),
                  (a.name = "program" + s),
                  (this.context.programs[s] = o.compile(
                    a,
                    e,
                    this.context,
                    !this.precompile,
                  )),
                  (this.context.decorators[s] = o.decorators),
                  (this.context.environments[s] = a),
          ...
          popStack: function (t) {
            ...
            if (!t && n instanceof s) return n.value;
            if (!e) {
          ...
          setupHelper: function (t, e, n) {
            ...
            return {
              params: a,
              paramsInit: this.setupHelperArgs(e, t, a, n),
          ...
          setupParams: function (t, e, n) {
            var a,
              ...
              c = this.popStack();
            (c || t) &&
              ((o.fn = c || "container.noop"),
              (o.inverse = t || "container.noop"));
            for (var u = e; u--; )
              (a = this.popStack()),
                (n[u] = a),
                this.trackIds && (s[u] = this.popStack()),
                this.stringParams &&
                  ((i[u] = this.popStack()), (r[u] = this.popStack()));
            return (
              l && (o.args = this.source.generateArray(n)),
              this.trackIds && (o.ids = this.source.generateArray(s)),
              this.stringParams &&
                ((o.types = this.source.generateArray(i)),
          ...
          setupHelperArgs: function (t, e, n, a) {
            t = this.setupParams(t, e, n);
            return (
              ...
              var a = this,
                ...
                t =
                  (i(n).forEach(function (t) {
                    var e = r(n[t], a);
                    "undefined" !== e && o.push([a.quotedString(t), ":", e]);
                  }),
                  this.generateList(o));
              return t.prepend("{"), t.add("}"), t;
            },
            generateList: function (t) {
              for (var e = this.empty(), n = 0, a = t.length; n < a; n++)
                n && e.add(","), e.add(r(t[n], this));
              return e;
            },
  ...
  Handlebars.registerHelper("desktopbackground", function (t) {
    var e = 'style="';
    if (!t) return "";
    switch (t.type) {
      case "image":
        e += "background-image: url('" + t.url + "');";
        var n = t.image.filter ?? "";
        "" != n && (e += "filter: " + n + ";");
        break;
      case "bgcolor":
        e += "backgroundColor: " + t.bgcolor + ";";
        break;
      case "filter":
        e += "background-image: " + t.filter + ";";
    }
    return (e += '"'), new Handlebars.SafeString(e);
  }),
  Handlebars.registerHelper("humandate", function (t) {
    (t = new Date(t)),
      (t = t.toLocaleDateString() + " " + t.toLocaleTimeString());
    return new Handlebars.SafeString(t);
  }),
  Handlebars.registerHelper("humandateonly", function (t) {
    t = new Date(t).toLocaleDateString("en-GB", {
      weekday: "short",
      day: "numeric",
      month: "short",
    });
  ...
  Handlebars.registerHelper("isempty", function (t, e) {
    return !t || "" === t ? e.fn(this) : e.inverse(this);
  }),
  Handlebars.registerHelper("isnotempty", function (t, e) {
    return !t || "" === t ? e.inverse(this) : e.fn(this);
  }),
  Handlebars.registerHelper("label", function (t, e) {
    return e.Config.Labels[t]
      ? new Handlebars.SafeString(e.Config.Labels[t])
      : new Handlebars.SafeString("");
  }),
  Handlebars.registerHelper("map", function (t, e) {
    if (!Array.isArray(t)) return "";
    for (var n = t.length, a = new Array(n), o = -1; ++o < n; )
      a[o] = "function" != typeof e ? t[o][e] : e(t[o], o, t);
    return a;
  }),
  ...
  Handlebars.registerHelper("service", function (t, e, n, a, o) {
    var r = "",
      i = "",
      s = n,
      n = "container",
    ...
    switch (
      ((s.opacity = a),
      t.includes(".") &&
        ((n = (a = t.toLowerCase().split("."))[0].toLowerCase()), (l = a[1])),
      n)
    ) {
      case "widget":
        i = t.toLowerCase().replace(".", "-").replace(/\//g, "_");
        "weather" === l
          ? ((c =
              ...
              "&longitude=" +
              o.longitude),
            o.days && (c += "&days=" + o.days),
            (r =
              '<div class="hbs-template" data-url="' +
              c +
              '"  data-template="partials/widget-weather"></div>'),
            (o.serviceUrl = c))
          : (c = Handlebars.partials[i]) && (r = c({ settings: o, parent: s }));
        break;
      case "container":
        (i = "service".replace(/\//g, "_")),
          e.forEach((t) => {
            var e;
            t.containerName.toLowerCase() == l &&
              ((e = Handlebars.partials[i]),
              (r = e({ service: t, parent: s })));
          });
        break;
      case "link":
        i = "widget-link";
        ...
        o &&
          ...
          (u = o.iconCatalog ?? ""),
          (p = o.iconSlug ?? ""));
        r = (0, Handlebars.partials[i])({
          settings: { iconCatalog: u, iconSlug: p, url: c, name: t },
          parent: s,
        });
    }
    return new Handlebars.SafeString(r);
  }),
  Handlebars.registerHelper("stringify", function (t) {
    return new Handlebars.SafeString(JSON.stringify(t, null, 0));
  }),
  (this.app = this.app || {}),
  (this.app.templates = this.app.templates || {}),
  (this.app.templates.compose = Handlebars.template({
    compiler: [8, ">= 4.3.0"],
    main: function (t, e, n, a, o) {
  ...
  (this.app.templates.containerinfo = Handlebars.template({
    1: function (t, e, n, a, o) {
      ...
      return t.escapeExpression(
        "function" ==
          typeof (n =
            null !=
            (n = r(n, "icon_slug") || (null != e ? r(e, "icon_slug") : e))
              ? n
          ...
          ? n.call(null != e ? e : t.nullContext || {}, {
              ...
              data: o,
              loc: {
                start: { line: 10, column: 121 },
                end: { line: 10, column: 134 },
              },
            })
          : n,
      );
    ...
    3: function (t, e, n, a, o) {
      ...
      return t.escapeExpression(
        "function" ==
          typeof (n =
            null != (n = r(n, "Name") || (null != e ? r(e, "Name") : e))
              ? n
              : t.hooks.helperMissing)
          ? n.call(null != e ? e : t.nullContext || {}, {
              name: "Name",
              ...
              data: o,
              loc: {
                start: { line: 10, column: 142 },
                end: { line: 10, column: 150 },
              },
            })
          : n,
      );
    },
    5: function (t, e, n, a, o) {
      return "Update Available";
    },
    7: function (t, e, n, a, o) {
      return "Up-to-date";
    },
    9: function (t, e, n, a, o) {
      var r = t.escapeExpression,
        i =
          t.lookupProperty ||
          function (t, e) {
            if (Object.prototype.hasOwnProperty.call(t, e)) return t[e];
      ...
      return (
        ...
        r(
          "function" ==
            typeof (n =
              null != (n = i(n, "Name") || (null != e ? i(e, "Name") : e))
                ? n
                : t.hooks.helperMissing)
            ? n.call(null != e ? e : t.nullContext || {}, {
                name: "Name",
                ...
                data: o,
                loc: {
                  start: { line: 52, column: 79 },
                  end: { line: 52, column: 87 },
                },
              })
            : n,
        ) +
        ...
        r(
          t.lambda(
            null != (o = null != e ? i(e, "editor") : e) ? i(o, "project") : o,
            e,
          ),
        ) +
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        u(
          typeof (i =
            null != (i = h(n, "Name") || (null != e ? h(e, "Name") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "Name",
        ...
        (null !=
        (r = h(n, "if").call(s, null != e ? h(e, "icon_slug") : e, {
          name: "if",
          hash: {},
          fn: t.program(1, o, 0),
          ...
          data: o,
          loc: {
            start: { line: 10, column: 104 },
            end: { line: 10, column: 157 },
          },
        }))
          ? r
          : "") +
        ...
        u(
          p(
            null != (r = null != e ? h(e, "Config") : e) ? h(r, "Hostname") : r,
            e,
          ),
        ) +
        "</td>\n            </tr>\n            <tr>\n              <td>Image:</td>\n              <td>" +
        u(
          p(
            null != (r = null != e ? h(e, "Config") : e) ? h(r, "Image") : r,
            e,
          ),
        ) +
        "</td>\n            </tr>\n            <tr>\n              <td></td>\n              <td>" +
        ...
        (r = h(n, "if").call(
          s,
          null != (r = null != e ? h(e, "UpdateStatus") : e)
            ? h(r, "updateDue")
            : r,
          {
            name: "if",
        ...
        u(
          p(
            null != (r = null != e ? h(e, "State") : e) ? h(r, "Status") : r,
            e,
          ),
        ) +
        "</td>\n            </tr>\n            <tr>\n              <td>Health:</td>\n              <td>" +
        ...
        u(
          typeof (i =
            ...
            ? i.call(s, {
                ...
                data: o,
                loc: {
                  start: { line: 48, column: 74 },
                  end: { line: 48, column: 82 },
                },
              })
            : i,
        ) +
        ...
        u(
          typeof (i =
            ...
            ? i.call(s, {
                ...
                data: o,
                loc: {
                  start: { line: 49, column: 74 },
                  end: { line: 49, column: 82 },
                },
              })
            : i,
        ) +
        ...
        (r = h(n, "if").call(
          s,
          null != (r = null != e ? h(e, "editor") : e) ? h(r, "editable") : r,
          {
            name: "if",
            hash: {},
            fn: t.program(9, o, 0),
  ...
  (this.app.templates.desktopheader = Handlebars.template({
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        (null !=
        (r = t.invokePartial(r(a, "themechooser"), e, {
          name: "themechooser",
          data: o,
          indent: "          ",
          helpers: n,
  ...
  (this.app.templates.dockerps = Handlebars.template({
    1: function (t, e, n, a, o) {
      ...
      return (
        "      <tr>\n        <td>\n          <a " +
        (null !=
        (r = p(n, "if").call(s, null != e ? p(e, "publicUrl") : e, {
          name: "if",
          hash: {},
          fn: t.program(2, o, 0),
        ...
        u(
          typeof (i =
            null != (i = p(n, "name") || (null != e ? p(e, "name") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "name",
        ...
        u(
          typeof (i =
            null != (i = p(n, "id") || (null != e ? p(e, "id") : e)) ? i : l) ==
            c
            ? i.call(s, {
                name: "id",
                hash: {},
        ...
        '" ' +
        (null !=
        (r = p(n, "if").call(s, null != e ? p(e, "healthy") : e, {
          name: "if",
          hash: {},
          fn: t.program(10, o, 0),
        ...
        u(
          typeof (i =
            ...
            ? i.call(s, {
                ...
                data: o,
                loc: {
                  start: { line: 20, column: 154 },
                  end: { line: 20, column: 162 },
                },
              })
            : i,
        ) +
        ...
        u(
          typeof (i =
            null != (i = p(n, "status") || (null != e ? p(e, "status") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "status",
        ...
        ">\n          " +
        (null !=
        (r = p(n, "if").call(s, null != e ? p(e, "shutdown") : e, {
          name: "if",
          hash: {},
          fn: t.program(17, o, 0),
          inverse: t.program(19, o, 0),
          data: o,
          loc: {
        ...
        (r = p(n, "if").call(s, null != e ? p(e, "shutdown") : e, {
          ...
          hash: {},
          fn: t.program(17, o, 0),
          inverse: t.program(21, o, 0),
          data: o,
          loc: {
            start: { line: 25, column: 72 },
            end: { line: 25, column: 128 },
          },
        }))
          ? r
          : "") +
        ...
        (r = p(n, "if").call(s, null != e ? p(e, "shutdown") : e, {
          ...
          hash: {},
          fn: t.program(17, o, 0),
          inverse: t.program(25, o, 0),
          data: o,
          loc: {
            start: { line: 26, column: 118 },
      ...
      return (
        ...
        t.escapeExpression(
          "function" ==
            typeof (n =
              null !=
              (n = r(n, "publicUrl") || (null != e ? r(e, "publicUrl") : e))
                ? n
                : t.hooks.helperMissing)
            ? n.call(null != e ? e : t.nullContext || {}, {
                name: "publicUrl",
    ...
    15: function (t, e, n, a, o) {
      return 'class="text-danger" ';
    },
    17: function (t, e, n, a, o) {
      return "-";
    },
    19: function (t, e, n, a, o) {
      var r =
        t.lookupProperty ||
        function (t, e) {
          if (Object.prototype.hasOwnProperty.call(t, e)) return t[e];
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        t.escapeExpression(
          "function" ==
            typeof (r =
              null != (r = s(n, "now") || (null != e ? s(e, "now") : e))
                ? r
                : t.hooks.helperMissing)
            ? r.call(i, {
                name: "now",
  ...
  (this.app.templates.projects = Handlebars.template({
    1: function (t, e, n, a, o) {
      ...
      return (
        ...
        (null !=
        (r = p(n, "if").call(s, o && p(o, "first"), {
          name: "if",
          hash: {},
          fn: t.program(2, o, 0),
          inverse: t.program(4, o, 0),
          data: o,
          loc: { start: { line: 5, column: 39 }, end: { line: 5, column: 78 } },
        }))
          ? r
          : "") +
        ...
        u(
          typeof (i =
            null != (i = p(n, "index") || (o && p(o, "index"))) ? i : l) == c
            ? i.call(s, {
                name: "index",
                hash: {},
                data: o,
                loc: {
                  start: { line: 5, column: 146 },
                  end: { line: 5, column: 156 },
                },
              })
            : i,
        ) +
        ...
        u(
          typeof (i =
            ...
            ? i.call(s, {
                ...
                data: o,
                loc: {
                  start: { line: 5, column: 203 },
                  end: { line: 5, column: 213 },
                },
              })
            : i,
        ) +
        ...
        u(
          typeof (i =
            null != (i = p(n, "key") || (o && p(o, "key"))) ? i : l) == c
            ? i.call(s, {
                name: "key",
                hash: {},
                data: o,
        ...
        (r = p(n, "if").call(s, o && p(o, "first"), {
          ...
          inverse: t.noop,
          data: o,
          loc: { start: { line: 9, column: 70 }, end: { line: 9, column: 96 } },
        }))
          ? r
          : "") +
        ...
        u(
          typeof (i =
            null != (i = p(n, "config") || (null != e ? p(e, "config") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "config",
        ...
        u(
          typeof (i =
            null !=
            (i = p(n, "environment") || (null != e ? p(e, "environment") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "environment",
        ...
        u(
          typeof (i =
            null !=
            (i =
              p(n, "workingFolder") || (null != e ? p(e, "workingFolder") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "workingFolder",
        ...
        (null !=
        (r = p(n, "each").call(s, null != e ? p(e, "containers") : e, {
          name: "each",
          hash: {},
          fn: t.program(8, o, 0),
          inverse: t.noop,
        ...
        "                  </tbody>\n                </table>\n" +
        (null !=
        (r = p(n, "if").call(s, null != e ? p(e, "editable") : e, {
          name: "if",
          hash: {},
          fn: t.program(10, o, 0),
          inverse: t.noop,
      ...
      return (
        ...
        c(
          typeof (r =
            null !=
            (r =
              t(n, "containerName") || (null != e ? t(e, "containerName") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "containerName",
        ...
        c(
          typeof (r =
            null != (r = t(n, "hostname") || (null != e ? t(e, "hostname") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "hostname",
    ...
    10: function (t, e, n, a, o) {
      ...
      return (
        ...
        l(
          typeof (e =
            null !=
            (e = t(n, "projectPath") || (null != e ? t(e, "projectPath") : e))
              ? e
              : i) == s
            ? e.call(r, {
                name: "projectPath",
                ...
                data: o,
                loc: {
                  start: { line: 51, column: 87 },
                  end: { line: 51, column: 102 },
                },
              })
            : e,
        ) +
        ...
        l(
          typeof (e =
            null != (e = t(n, "key") || (o && t(o, "key"))) ? e : i) == s
            ? e.call(r, {
                name: "key",
                hash: {},
                data: o,
                loc: {
                  start: { line: 51, column: 118 },
                  end: { line: 51, column: 126 },
                },
              })
            : e,
        ) +
    ...
    main: function (t, e, n, a, o) {
      return (
        ...
        )(n, "each").call(null != e ? e : t.nullContext || {}, e, {
          name: "each",
          hash: {},
          fn: t.program(1, o, 0),
          inverse: t.noop,
          data: o,
          loc: { start: { line: 2, column: 2 }, end: { line: 59, column: 11 } },
        }))
          ? n
          : "") +
        "</div>\n"
  ...
  (this.app.templates.service = Handlebars.template({
    ...
    9: function (t, e, n, a, o) {
      ...
      return (
        ...
        t.escapeExpression(
          t.lambda(
            null != (t = null != e ? r(e, "parent") : e) ? r(t, "opacity") : t,
            e,
          ),
        ) +
        " !important;"
    ...
    11: function (t, e, n, a, o) {
      return "/api/icons/question";
    },
    13: function (t, e, n, a, o) {
      var r,
        i = t.lambda,
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        (r = u(n, "if").call(
          i,
          null != (r = null != e ? u(e, "service") : e) ? u(r, "available") : r,
          {
            name: "if",
            hash: {},
            fn: t.program(1, o, 0),
        ...
        l(
          s(
            null != (r = null != e ? u(e, "service") : e) ? u(r, "public") : r,
            e,
          ),
        ) +
        '" onclick="navigateTo(this); return false;" type="button" class="btn ' +
        (null !=
        (r = (u(n, "isempty") || (e && u(e, "isempty")) || c).call(
          i,
          null != (r = null != e ? u(e, "parent") : e)
            ? u(r, "buttonclass")
            : r,
          {
            name: "isempty",
        ...
        ' widget" style="' +
        (null !=
        (r = (u(n, "isnotempty") || (e && u(e, "isnotempty")) || c).call(
          i,
          null != (r = null != e ? u(e, "parent") : e) ? u(r, "opacity") : r,
          {
            name: "isnotempty",
            hash: {},
            fn: t.program(9, o, 0),
            ...
            data: o,
            loc: {
              start: { line: 1, column: 295 },
              end: { line: 1, column: 378 },
            },
          },
        ))
          ? r
        ...
        (r = (u(n, "isempty") || (e && u(e, "isempty")) || c).call(
          i,
          null != (r = null != e ? u(e, "service") : e) ? u(r, "iconSlug") : r,
          {
            name: "isempty",
            hash: {},
            fn: t.program(11, o, 0),
        ...
        l(
          s(
            null != (r = null != e ? u(e, "service") : e) ? u(r, "name") : r,
            e,
          ),
        ) +
        "\n</button>\n"
  ...
  (this.app.templates["widget-discovrninja"] = Handlebars.template({
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        (null !=
        (r = (l(n, "isempty") || (e && l(e, "isempty")) || s).call(
          i,
          null != (r = null != e ? l(e, "parent") : e)
            ? l(r, "buttonclass")
            : r,
          {
            name: "isempty",
        ...
        ' widget" style="' +
        (null !=
        (r = (l(n, "isnotempty") || (e && l(e, "isnotempty")) || s).call(
          i,
          null != (r = null != e ? l(e, "parent") : e) ? l(r, "opacity") : r,
          {
            name: "isnotempty",
            hash: {},
            fn: t.program(5, o, 0),
            ...
            data: o,
            loc: {
              start: { line: 1, column: 222 },
              end: { line: 1, column: 305 },
            },
          },
        ))
          ? r
  ...
  (this.app.templates["widget-link"] = Handlebars.template({
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        s(
          i(
            null != (r = null != e ? u(e, "settings") : e) ? u(r, "url") : r,
            e,
          ),
        ) +
        '" onclick="navigateTo(this); return false;" type="button" class="btn ' +
        ...
        (r = (u(n, "isempty") || (e && u(e, "isempty")) || c).call(
          l,
          null != (r = null != e ? u(e, "settings") : e) ? u(r, "iconSlug") : r,
          {
            name: "isempty",
            hash: {},
            fn: t.program(7, o, 0),
            inverse: t.program(9, o, 0),
            data: o,
            loc: {
              start: { line: 2, column: 64 },
              end: { line: 2, column: 253 },
            },
          },
        ))
          ? r
        ...
        s(
          i(
            null != (r = null != e ? u(e, "settings") : e) ? u(r, "name") : r,
            e,
          ),
        ) +
        "\n</button>\n"
  ...
  (this.app.templates["widget-news"] = Handlebars.template({
    ...
    9: function (t, e, n, a, o) {
      ...
      return t.escapeExpression(
        t.lambda(
          null != (t = null != e ? r(e, "settings") : e) ? r(t, "iconUrl") : t,
          e,
        ),
      );
    },
      ...
      return (
        ...
        (r = (u(n, "isempty") || (e && u(e, "isempty")) || c).call(
            ...
            : r,
          {
            ...
            data: o,
            loc: {
              start: { line: 1, column: 107 },
              end: { line: 1, column: 194 },
            },
          },
        ))
          ? r
        ...
        (r = (u(n, "isnotempty") || (e && u(e, "isnotempty")) || c).call(
          ...
          null != (r = null != e ? u(e, "parent") : e) ? u(r, "opacity") : r,
          {
            ...
            data: o,
            loc: {
              start: { line: 1, column: 210 },
              end: { line: 1, column: 293 },
            },
          },
        ))
          ? r
        ...
        (r = (u(n, "isempty") || (e && u(e, "isempty")) || c).call(
          l,
          null != (r = null != e ? u(e, "settings") : e) ? u(r, "iconUrl") : r,
          {
            name: "isempty",
            hash: {},
            fn: t.program(7, o, 0),
  ...
  (this.app.templates["widget-weather"] = Handlebars.template({
    1: function (t, e, n, a, o, r, i) {
      ...
      return (
        ...
        (null !=
        (s = (d(n, "isempty") || (e && d(e, "isempty")) || c).call(
          l,
          null !=
            (s =
              null != (s = null != i[1] ? d(i[1], "_s") : i[1]) ? d(s, "p") : s)
            ? d(s, "buttonclass")
            : s,
          {
            name: "isempty",
            hash: {},
            fn: t.program(2, o, 0, r, i),
            inverse: t.program(4, o, 0, r, i),
            data: o,
            loc: {
        ...
        (null !=
        (s = (d(n, "isnotempty") || (e && d(e, "isnotempty")) || c).call(
          l,
          null !=
            (s =
              null != (s = null != i[1] ? d(i[1], "_s") : i[1]) ? d(s, "p") : s)
            ...
            : s,
          {
            name: "isnotempty",
            hash: {},
            fn: t.program(6, o, 0, r, i),
            inverse: t.noop,
            data: o,
            loc: {
              start: { line: 5, column: 165 },
              end: { line: 5, column: 250 },
            },
          },
        ))
          ? s
        ...
        p(
          u(
            null != (s = null != i[1] ? d(i[1], "settings") : i[1])
              ? d(s, "latitude")
              : s,
            e,
          ),
        ...
        p(
          typeof (r =
            null != (r = d(n, "index") || (o && d(o, "index"))) ? r : c) == h
            ? r.call(l, {
                name: "index",
                hash: {},
                data: o,
                loc: {
                  start: { line: 5, column: 349 },
                  end: { line: 5, column: 359 },
                },
              })
            : r,
        ) +
        ...
        p(
          typeof (r =
            null != (r = d(n, "icon") || (null != e ? d(e, "icon") : e))
              ? r
              : c) == h
            ? r.call(l, {
                name: "icon",
        ...
        p(
          typeof (r =
            null != (r = d(n, "date") || (null != e ? d(e, "date") : e))
              ? r
              : c) == h
            ? r.call(l, {
                name: "date",
    ...
    4: function (t, e, n, a, o, r, i) {
      ...
      return t.escapeExpression(
        t.lambda(
          null !=
            (t =
              null != (t = null != i[1] ? s(i[1], "_s") : i[1]) ? s(t, "p") : t)
            ? s(t, "buttonclass")
            : t,
          e,
        ),
    ...
    main: function (t, e, n, a, o, r, i) {
      ...
      return (
        ...
        (n = c(n, "each").call(
          null != e ? e : t.nullContext || {},
          null != e ? c(e, "weather") : e,
          {
            name: "each",
            hash: {},
            fn: t.program(1, o, 0, r, i),
            inverse: t.noop,
            data: o,
            loc: {
  ...
  (this.app.templates.news = Handlebars.template({
    1: function (t, e, n, a, o) {
      ...
      return (
        ...
        t.escapeExpression(
          typeof (i =
            null != (i = u(n, "link") || (null != e ? u(e, "link") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "link",
        ...
        (r =
          typeof (i =
            null != (i = u(n, "title") || (null != e ? u(e, "title") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "title",
                ...
                data: o,
                loc: {
                  start: { line: 17, column: 107 },
                  end: { line: 17, column: 118 },
                },
              })
            : i)
          ? r
        ...
        "</a></p>\n            " +
        (null !=
        (r = u(n, "if").call(s, null != e ? u(e, "image") : e, {
          name: "if",
          hash: {},
          fn: t.program(2, o, 0),
          inverse: t.noop,
        ...
        (r =
          typeof (i =
            null !=
            (i = u(n, "description") || (null != e ? u(e, "description") : e))
              ? i
              : l) == c
            ? i.call(s, {
                name: "description",
    ...
    2: function (t, e, n, a, o) {
      ...
      return (
        ...
        t.escapeExpression(
          t.lambda(
            null != (t = null != e ? r(e, "image") : e) ? r(t, "url") : t,
            e,
          ),
        ) +
        '" />'
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        s(
          "function" ==
            typeof (r =
              null != (r = c(n, "feedUrl") || (null != e ? c(e, "feedUrl") : e))
                ? r
                : t.hooks.helperMissing)
            ? r.call(i, {
                name: "feedUrl",
        ...
        s(
          l(
            null !=
              (r =
                null != (r = null != e ? c(e, "meta") : e) ? c(r, "image") : r)
              ? c(r, "url")
              : r,
            e,
          ),
        ...
        s(
          l(
            null != (r = null != e ? c(e, "meta") : e) ? c(r, "pubDateStr") : r,
            e,
          ),
        ) +
        "\n        </td>\n      </tr>\n" +
        (null !=
        (r = c(n, "each").call(i, null != e ? c(e, "items") : e, {
          name: "each",
          hash: {},
          fn: t.program(1, o, 0),
          inverse: t.noop,
  ...
  (this.app.templates.weather = Handlebars.template({
    ...
    main: function (t, e, n, a, o) {
      ...
      return (
        ...
        c(
          typeof (r =
            null != (r = t(n, "date") || (null != e ? t(e, "date") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "date",
        ...
        c(
          typeof (r =
            null != (r = t(n, "icon") || (null != e ? t(e, "icon") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "icon",
        ...
        c(
          typeof (r =
            null != (r = t(n, "text") || (null != e ? t(e, "text") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "text",
                ...
                data: o,
                loc: {
                  start: { line: 3, column: 123 },
                  end: { line: 3, column: 131 },
                },
              })
            : r,
        ) +
        ...
        c(
          typeof (r =
            null != (r = t(n, "sunrise") || (null != e ? t(e, "sunrise") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "sunrise",
        ...
        c(
          typeof (r =
            null != (r = t(n, "sunset") || (null != e ? t(e, "sunset") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "sunset",
        ...
        c(
          typeof (r =
            null !=
            (r =
              t(n, "temperature2m") || (null != e ? t(e, "temperature2m") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "temperature2m",
        ...
        c(
          typeof (r =
            null !=
            (r =
              t(n, "precipitationProbabilityMax") ||
              (null != e ? t(e, "precipitationProbabilityMax") : e))
              ? r
              : s) == l
            ? r.call(i, {
        ...
        c(
          typeof (r =
            null !=
            (r =
              t(n, "windDirection10mDominant") ||
              (null != e ? t(e, "windDirection10mDominant") : e))
              ? r
              : s) == l
            ? r.call(i, {
        ...
        c(
          typeof (r =
            null !=
            (r =
              t(n, "windDirection") || (null != e ? t(e, "windDirection") : e))
              ? r
              : s) == l
            ? r.call(i, {
                name: "windDirection",
  ...
  (window._render = function (c, u) {
    return new Promise((e, n) => {
      var t = c.getAttribute("data-url"),
        a = c.getAttribute("data-template"),
        o = null,
        r = c.getAttribute("data-refresh-interval"),
        i = null,
        s =
          (c.getAttribute("data-settings") &&
            ((s = c.getAttribute("data-settings")),
            (s = window.atob(s)),
            (o = JSON.parse(s))),
          ""),
        l =
          ((s += (i =
            u &&
            (u.url && (t = u.url),
            u.template && (a = u.template),
            u.refreshInterval && (r = u.refreshInterval),
            u.query)
              ? u.query
              : i)
            ? t.format(u.query)
  ...
  (window.ui = function (t) {
    var r = [];
    return (
      t && (r = document.querySelectorAll(t)),
      window._stateStore || (window._stateStore = {}),
      {
        observe: function (t) {
          var e =
            "__OBS_" +
            t.getAttribute("data-template").split("/").pop() +
            "_" +
            name;
          (window._stateStore[e] = new MutationObserver((t, e) => {})),
            window._stateStore[e].observe(t, { childList: !0, subtree: !0 });
        },
        template: function (o) {
          return new Promise((e, n) => {
            var a;
        ...
        messageBox: function (t) {
          (document.getElementById("msgboxLabel").innerHTML = t.label),
            (document.getElementById("msgboxBody").innerHTML = t.body);
        ...
        toast: function (t) {
          (document.getElementById("toastLabel").innerHTML = t.label),
            (document.getElementById("toastBody").innerHTML = t.body),
            (document.getElementById("toastSmall").innerHTML = t.small ?? "");
          t = {
            animation: !0,
        ...
        themeChooser: function () {
          return {
            ...
            setStoredTheme: function (t) {
              localStorage.setItem("theme", t);
            },
            getPreferredTheme: function () {
              var t = this.getStoredTheme();
              return (
                t ||
            ...
            chooseTheme: function (t) {
              var e = document.getElementById("activeTheme"),
                n = document.getElementById(t).className;
              (e.className = n), this.setTheme(t), this.setStoredTheme(t);
            },
          };
        },
      }
  ...
  (String.prototype.format = function (t) {
    var e,
      n = this;
    for (e in t)
      t.hasOwnProperty(e) && (n = n.replace(RegExp("{" + e + "}", "g"), t[e]));
    return n;
  });
