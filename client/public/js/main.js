...
this["app"]["templates"]["dockerps"] = Handlebars.template({
  1: function(container, depth0, helpers, partials, data) {
    ...
    return "      <tr>\n        <td>\n          <a " + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "publicUrl") : depth0, {
      name: "if",
      hash: {},
    ...
    })) != null ? stack1 : "") + '><i class="fa-solid fa-link"></i></a>\n          <a href="#" data-containerid="' + alias4((helper = (helper = lookupProperty(helpers, "name") || (depth0 != null ? lookupProperty(depth0, "name") : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "name",
      hash: {},
      data: data,
      loc: {
    ...
    }) : helper)) + '" ' + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "publicUrl") : depth0, {
      name: "if",
      hash: {},
    ...
    })) != null ? stack1 : "") + '><i class="fa-regular fa-font-awesome"></i></a>\n        </td>\n        <td><a href="#" data-containerid="' + alias4((helper = (helper = lookupProperty(helpers, "id") || (depth0 != null ? lookupProperty(depth0, "id") : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "id",
      hash: {},
      data: data,
      loc: {
    ...
    })) != null ? stack1 : "") + ">" + alias4((helper = (helper = lookupProperty(helpers, "status") || (depth0 != null ? lookupProperty(depth0, "status") : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "status",
      hash: {},
      data: data,
      loc: {
...
this["app"]["templates"]["projects"] = Handlebars.template({
  ...
  8: function(container, depth0, helpers, partials, data) {
    ...
    return "                      <tr>\n                        <td>" + alias4((helper = (helper = lookupProperty(helpers, "containerName") || (depth0 != null ? lookupProperty(depth0, "containerName") : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "containerName",
      hash: {},
      data: data,
      loc: {
  ...
  10: function(container, depth0, helpers, partials, data) {
    ...
    return '                  <button onclick="composeEdit(this); return false;" data-projectpath="' + alias4((helper = (helper = lookupProperty(helpers, "projectPath") || (depth0 != null ? lookupProperty(depth0, "projectPath") : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "projectPath",
      hash: {},
      data: data,
      loc: {
    ...
    }) : helper)) + '" data-project="' + alias4((helper = (helper = lookupProperty(helpers, "key") || data && lookupProperty(data, "key")) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
      name: "key",
      hash: {},
      data: data,
      loc: {
    ...
    }) : helper)) + '" type="button" class="btn btn-primary"><i class="fa-regular fa-pen-to-square"></i> Edit</button>\n'
  },
  compiler: [8, ">= 4.3.0"],
  main: function(container, depth0, helpers, partials, data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
...
this["app"]["templates"]["news"] = Handlebars.template({
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return '<div id="news" class="newsprint">\n  <div class="content">\n    <table border="0" cellpadding="2" cellspacing="0">\n      <tr class="masthead">\n        <td>\n          <a href="#" onclick="newsPage(\'' + alias2((helper = (helper = lookupProperty(helpers, "feedUrl") || (depth0 != null ? lookupProperty(depth0, "feedUrl") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(alias1, {
      name: "feedUrl",
      hash: {},
      data: data,
      loc: {
